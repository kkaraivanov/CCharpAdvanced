namespace Stealer
{
    ...
    public class Spy
    {
        ...
        public string CollectGettersAndSeters(string className)
        {
            var sb = new StringBuilder();
            var classType = Type.GetType(className);
            var classMethods = classType
                .GetMethods(BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
            sb.AppendLine(GetClassWithGetMethods(classMethods));
            sb.AppendLine(GetClassWithSetMethods(classMethods));

            return sb.ToString().Trim();
        }

        private string GetClassWithGetMethods(MethodInfo[] methods)
        {
            var sb = new StringBuilder();
        ...
        private string GetClassWithSetMethods(MethodInfo[] methods)
        {
            var sb = new StringBuilder();
